...
public static class JsonValueTests
{
    ...
    {
        { new(new JsonValue.Null()), null },
        { new(new JsonValue.String("abc")), null },
        { new(new JsonValue.Number(1234)), null },
        { new(new JsonValue.Boolean(true)), null },
        { new(new JsonValue.Boolean(false)), null },
        { new(new JsonValue.Array(_array)), new(_array) },
        { new(new JsonValue.Object(_object)), null }
    };
    ...
    public static TheoryData<JsonValue, JsonValue.Boolean?> ExplicitCast_FromJsonValue_ToBooleanJsonValue_Data => new()
    {
        ...
        { new(new JsonValue.String("abc")), null },
        { new(new JsonValue.Number(1234)), null },
        { new(new JsonValue.Boolean(true)), new(true) },
        { new(new JsonValue.Boolean(false)), new(false) },
        { new(new JsonValue.Array(_array)), null },
        { new(new JsonValue.Object(_object)), null }
    };

    public static TheoryData<JsonValue, JsonValue.Null?> ExplicitCast_FromJsonValue_ToNullJsonValue_Data => new()
    {
        { new(new JsonValue.Null()), new() },
        { new(new JsonValue.String("abc")), null },
        { new(new JsonValue.Number(1234)), null },
        { new(new JsonValue.Boolean(true)), null },
        { new(new JsonValue.Boolean(false)), null },
    ...
    public static TheoryData<JsonValue, JsonValue.Number?> ExplicitCast_FromJsonValue_ToNumberJsonValue_Data => new()
    {
        { new(new JsonValue.Null()), null },
        { new(new JsonValue.String("abc")), null },
        { new(new JsonValue.Number(1234)), new(1234) },
        { new(new JsonValue.Boolean(true)), null },
        { new(new JsonValue.Boolean(false)), null },
        { new(new JsonValue.Array(_array)), null },
        { new(new JsonValue.Object(_object)), null }
    ...
    public static TheoryData<JsonValue, bool, JsonValue.Array> IsArray_Data => new()
    {
        ...
        { new(new JsonValue.Boolean(true)), false, default },
        { new(new JsonValue.Boolean(false)), false, default },
        { new(new JsonValue.Array(_array)), true, new(_array) },
        { new(new JsonValue.Object(_object)), false, default },
    };
    ...
    public static TheoryData<JsonValue, bool, JsonValue.Boolean> IsBoolean_Data => new()
    {
        ...
        { new(new JsonValue.String("abc")), false, default },
        { new(new JsonValue.Number(123)), false, default },
        { new(new JsonValue.Boolean(true)), true, new(true) },
        { new(new JsonValue.Boolean(false)), true, new(false) },
        { new(new JsonValue.Array(_array)), false, default },
        { new(new JsonValue.Object(_object)), false, default },
    };
    ...
    public static TheoryData<JsonValue, bool, JsonValue.Object> IsObject_Data => new()
    {
        ...
        { new(new JsonValue.Boolean(false)), false, default },
        { new(new JsonValue.Array(_array)), false, default },
        { new(new JsonValue.Object(_object)), true, new(_object) },
    };
    ...
    {
        { new(new JsonValue.Null()), null },
        { new(new JsonValue.String("abc")), "abc" },
        { new(new JsonValue.Number(1234)), 1234 },
        { new(new JsonValue.Boolean(true)), true },
        { new(new JsonValue.Boolean(false)), false },
        { new(new JsonValue.Array(_array)), _array },
        { new(new JsonValue.Object(_object)), _object },
    };

    public static TheoryData<JsonValue, string> Match_NoDefault_NullSelector_Data => new()
    {
        { new(new JsonValue.Null()), "caseNull" },
        { new(new JsonValue.String("abc")), "caseString" },
        { new(new JsonValue.Number(1234)), "caseNumber" },
        { new(new JsonValue.Boolean(true)), "caseBoolean" },
        { new(new JsonValue.Boolean(false)), "caseBoolean" },
        { new(new JsonValue.Array(_array)), "caseArray" },
        { new(new JsonValue.Object(_object)), "caseObject" },
    };

    public static TheoryData<JsonValue> Match_WithDefault_Default_Data => new()
    {
        new(new JsonValue.Null()),
        new(new JsonValue.String("abc")),
        new(new JsonValue.Number(1234)),
        new(new JsonValue.Boolean(true)),
        new(new JsonValue.Boolean(false)),
        new(new JsonValue.Array(_array)),
        new(new JsonValue.Object(_object)),
    };
