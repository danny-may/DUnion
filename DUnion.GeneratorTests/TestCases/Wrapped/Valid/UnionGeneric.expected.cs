...
/* Sources: 1 */
/* File Path: DUnion\DUnion.SourceGenerator\Wrapped.Valid.UnionGeneric.Union`1.DUnion.g.cs */
// =============================================================
...
namespace Wrapped.Valid.UnionGeneric
{
    partial record struct Union<T>
    {
        ...
        /// <summary>
        /// Creates a <see cref="Union{T}"/> which wraps a <see cref="Case"/>.
        /// </summary>
        ...
        [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute]
        public static implicit operator Union<T>(Case value)
        {
            return new Union<T>(value);
        }
        
        [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute]
        public static explicit operator Case(Union<T> value)
        {
